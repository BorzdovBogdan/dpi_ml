...
int main(int argc, char **argv)
{
    ...
    while (c!='q') {
         ...
         * to_ms is the read time out in milliseconds (a value of 0 means no time out; on at least some platforms,
         * this means that you may wait until a sufficient number of packets arrive before seeing any packets,
         * so you should use a non-zero timeout). Lastly,
